    ...
    <form id="editForm" class="layui-form" autocomplete="off">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="width: 300px;">
                <select name="grouptype" required lay-verify="required">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="gname" style="width:300px;" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="numcount" style="width:300px;" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
