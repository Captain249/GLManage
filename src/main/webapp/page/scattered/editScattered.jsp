...
<form id="editForm" class="layui-form" autocomplete="off">
    <input type="text" name="id" value="${editScattered.id}" hidden="hidden" >
    <div class="layui-form-item">
        <label class="layui-form-label">类型</label>
        <div class="layui-input-block" style="width: 300px;">
            <c:if test="${editScattered.type eq '国内航空线'}">
            ...
            <c:if test="${editScattered.type eq '出境'}">
                <select name="type" lay-verify="required">
                    <option value="">请选择</option>
            ...
            <c:if test="${editScattered.type eq '短线'}">
                <select name="type" lay-verify="required">
                    <option value="">请选择</option>
                    <option value="国内航空线">国内航空线</option>
                    <option value="出境">出境</option>
...
<script type="text/javascript">
    ...
    $("#submitbtn").click(function(){
        ...
        $.ajax({
            type:"POST",                             //请求的类型
            url:"<%=path %>/scattered/editScattered",                      //请求的路径
            data: form,                              //请求的参数
            async: false,
            cache: false,
            contentType: false,
