...
<head>
    <meta charset="utf-8">
    <title>国旅后台管理系统</title>
    <link rel="shortcut icon" href="<%=path%>/images/bg1.jpg">
    ...
    <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-left">
                ...
                <li class="layui-nav-item layui-hide-xs" lay-unselect>
                    <input type="text" placeholder="搜索功能待开发" autocomplete="off" class="layui-input layui-input-search"
        ...
        <div class="layui-body" id="LAY_app_body">
            <div class="layadmin-tabsbody-item layui-show">
                <iframe src="<%=path%>/sys/sysCtr" frameborder="0" class="layadmin-iframe"></iframe>
            </div>
        </div>
